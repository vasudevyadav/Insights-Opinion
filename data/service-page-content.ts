export const servicePageContent = {
  quantitative: {
    hero: {
      ...
      description:
        "is how businesses get reliable numbers behind their decisions. It measures customer preferences, buying behaviour, market demand, and brand performance.",
      insightText: "Turn Market Uncertainty into Actionable Insights",
      backgroundImage: "/quality/quant-banner.png",
    },
    about:
      "At Insights Opinion, we offer comprehensive quantitative market research services designed to give businesses clear, measurable answers. Our services include Online Surveys, CATI, CAPI, and CLT, covering every stage from data collection through analysis and reporting.",
    what: {
      headingLine1: "What Quantitative",
      headingLine2: "Market Research",
      suffix: "does for Your Business?",
      description:
      ...
      image: "/quality/quant-about.png",
      imageAlt: "Quantitative market research analytics",
      cards: [
        "Measure how customers feel about your product or brand across a large sample",
        "Track changes in satisfaction, awareness, or preference over time",
        "Validate a new product, concept, or pricing decision with real data",
        "Size a market or estimate demand before entering a new segment",
    ...
    methodCta: {
      ...
      description:
        "Share your audience and objectives, and our team will recommend the right survey or fieldwork approach.",
    },
    analysis: {
      heading: "Insights Opinion Analysis Services",
      paragraph1:
      ...
      paragraph2:
        "Every analysis is built around your study objectives, with clear and presentation-ready outputs.",
    },
    industries: {
      description:
        "Insights Opinion works with clients across multiple sectors for quantitative research.",
      useCasesLabel: "Typical Quantitative Research Use Cases",
      useCases: [
        "Patient behavior studies, HCP surveys, treatment preference tracking",
        "Product testing, brand tracking, purchase decision research",
        "Purchase intent, feature preference, CLT-based concept testing",
        "NPS measurement, product awareness, customer satisfaction",
        "User experience research, feature prioritization, churn studies",
        "Enrollment research, program awareness, student and parent surveys",
        "Decision-maker surveys, procurement research, B2B panel studies",
      ],
    },
    global: {
      heading: "Quantitative Research Services",
      description:
        "Our teams coordinate quantitative studies across 100+ countries with consistent central oversight and local market support.",
      officeDescriptions: [
        "Our New York team supports consumer, B2B, and healthcare quantitative research across the US.",
        "Our London office coordinates UK and European quantitative programmes across key industries.",
        "Our Noida hub supports multilingual fieldwork, survey programming, data processing, and CATI operations.",
      ],
    },
    whyRadial: {
      ...
      items: [
        ...
        "global panellists across consumer, B2B, and healthcare",
    ...
    whyChoose: {
      description:
        "Businesses choose our quantitative research services for accurate data, multilingual capabilities, and dependable project execution.",
      items: [
        {
          title: "Fast Panel Delivery & Sample Access",
          content:
            "Access global verified respondents across 100+ countries for online, telephone, and in-person studies.",
        },
        {
          title: "Custom Quantitative Research Design",
          content:
            "Every questionnaire, screening framework, quota, and validation rule is built around your objectives.",
        },
        {
          title: "Experienced Quantitative Analysts",
          content:
            "Our analysts apply advanced statistical methods and deliver findings ready for stakeholder decisions.",
        },
        {
          title: "Secure and Compliant Research",
          content:
            "Secure transfer, anonymisation, controlled access, and documented processes protect every study.",
        },
      ],
    },
    faqs: [
      {
        ...
        answer:
          "Quantitative research collects structured numerical data to measure behaviours, preferences, awareness, and market patterns.",
      },
      {
        question: "Which quantitative method should I use?",
        answer:
          "The right method depends on the audience, sample, market, questionnaire complexity, and collection requirements.",
      },
      {
        question: "Can quantitative research run internationally?",
        answer:
          "Yes. We coordinate multi-country studies with central management and local-language fieldwork support.",
      },
      {
        question: "How is quantitative data delivered?",
        answer:
          "Deliverables can include clean data, cross-tabs, statistical analysis, charts, dashboards, and reports.",
      },
    ],
    articles: [
      {
        ...
        desc: "See how structured research data supports more accurate market decisions.",
        href: "#",
      },
      {
        ...
        date: "May 2026",
        title: "Choosing Between CATI, CAWI and CLT",
        desc: "Compare core quantitative approaches for your next study.",
        href: "#",
      },
      {
        ...
        date: "April 2026",
        title: "Why Sample Size Still Matters",
        desc: "Understand representative sampling and statistical significance.",
        href: "#",
      },
    ],
  },
...
export function getServicePageContent(
  ...
  return servicePageContent[slug as ServicePageKey] ?? null;
}
