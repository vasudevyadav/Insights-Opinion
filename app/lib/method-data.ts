...
const methods: Record<string, MethodData> = {
  cati: {
    ...
    whenToUse: {
      ...
      bodyText:
        "Outsourcing CATI market research to Insights Opinion gives you fully managed CATI fieldwork services from brief to delivery. For studies needing panel respondents alongside telephone reach, our global panel of global profiled respondents works alongside CATI fieldwork.",
      image: "/quality/cati-telephone.png",
      items: [
  ...
  capi: {
    ...
    whenToUse: {
      ...
      bodyText:
        "Outsourcing CAPI research to Insights Opinion gives you fully managed face-to-face fieldwork from brief to delivery. For studies combining in-person reach with panel respondents, our global panel of global profiled respondents can complement CAPI fieldwork.",
      image: "/quality/cati-computer.png",
      items: [
  ...
  "online-surveys": {
    ...
    hero: {
      ...
      description:
        "Reach large, verified audiences fast with professionally designed online surveys backed by our global panel of global respondents.",
    },
    about:
      "At Insights Opinion, we are a full-service online survey research company with access to global verified panellists across consumer, B2B, and healthcare audiences in 100+ countries and 60+ languages. All projects are backed by ISO 27001 certified quality processes and end-to-end project management.",
    why: {
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "We access our global verified panellists across consumer, B2B, and healthcare audiences — applying quota controls to ensure representative samples across all required subgroups.",
    ...
    sectors: [
      { title: "Online Surveys for Consumer Research", image: "/quality/cati-online.png", description: "Consumer online surveys give you fast, scalable access to representative audience samples across demographics, geographies, and categories. Our panel of global verified respondents enables precise quota controls and rapid fieldwork completion for brand, product, and market studies." },
    ...
    faqs: [
      ...
      { q: "What panel does Insights Opinion use for online surveys?", a: "Insights Opinion uses its proprietary panel of global verified respondents across consumer, B2B, and healthcare audiences in 100+ countries. All panellists are double-opt-in verified with regular re-validation to maintain data quality." },
