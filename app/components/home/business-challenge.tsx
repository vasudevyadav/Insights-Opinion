        ...
        <div className="relative mt-5">
            <div className="flex items-end justify-center">
                <Image
                    ...
                    width={400}
                    height={260}
                    className="h-[20rem] w-full rounded-b-[18px] object-cover object-bottom"
        ...
        <section className="bg-white py-14 lg:py-12">
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div className=" lg:pt-2 lg:pl-20">
                    <h2 className="max-w-[400px] text-[34px] font-light leading-[1.1] text-[#4a5370] lg:text-5xl">
                        The Business
                        Challenges
                        <br />
                        <span className="font-semibold text-[#35c6cf] lg:text-[40px]">we solve</span>
                    </h2>
                </div>
