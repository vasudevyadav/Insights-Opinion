...
function CaseCard({ title, desc, image, accent, large = false }: CaseCardProps) {
    return (
        <div
            className={`group relative overflow-hidden rounded-2xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all duration-300 hover:-translate-y-1 hover:border-cyan-500/20 hover:shadow-[0_12px_40px_rgba(0,200,255,0.08)] ${large ? "h-[420px]" : "h-[400px]"
                }`}
        >
            {/* Background Image */}
            <img
        ...
        <section className="relative overflow-hidden bg-[#07102b] py-16 text-white">
            ...
            <div className="relative mx-auto max-w-5xl px-4 md:px-6">
                ...
                <div className="lg:-mb-10">
                    <h2 className="text-2xl font-normal text-transparent bg-clip-text bg-[linear-gradient(180deg,#5fb9aa_0%,#4fa7b4_50%,#5a8fc8_100%)] lg:text-[38px]">
                        Case Studies
                    </h2>
