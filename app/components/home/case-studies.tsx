...
export default function CaseStudies() {
    const rightColumnOffset = caseStudies[0]?.rightColumnOffset ?? "md:mt-0";
        ...
        <section className="relative overflow-hidden bg-[#07102b] py-16 text-white">
            ...
            <div className="relative mx-auto max-w-6xl px-5 md:px-8">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:-mt-10">
                    <div className={`flex flex-col gap-6 ${rightColumnOffset}`}>
...
function CaseCard({ title, desc, image, accent, large = false }: CaseStudy) {
    return (
        <div
