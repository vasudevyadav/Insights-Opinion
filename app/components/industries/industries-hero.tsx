    ...
    return (
        <section className="bg-[#edf6fe]">
            <div className="relative w-full overflow-hidden bg-[url('/about-us/about-us-hero-bg.webp')] bg-cover bg-center bg-no-repeat text-white">
                <div className="relative z-10 mx-auto flex min-h-[260px] w-full max-w-7xl items-center px-5 sm:px-6 lg:min-h-[450px] lg:px-8">
                    <div className="mx-auto text-center">
                        <h1 className="site-page-title bg-gradient-to-r from-[#21c4b4] to-[#5ba9ef] bg-clip-text text-transparent">
                            Industries
                        </h1>
                        <p className="mt-4 lg:text-base text-sm  text-white/85">Home <span className="mx-2 text-[#35c6cf]">›</span> Industries</p>
                    </div>
                </div>
            </div>
        </section>
