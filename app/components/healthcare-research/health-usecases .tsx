            ...
            <div className="relative z-10 mb-5 flex w-full max-w-5xl flex-wrap items-start justify-center gap-y-5 md:flex-nowrap md:justify-between">
              {useCases.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`relative mb-5 flex h-10 w-10 items-center justify-center rounded-full border transition-all duration-500 ${
                        isActive
                    ...
                    <p
                      className={`mt-2 text-[10px] leading-[1.3] transition-all duration-500 lg:text-sm ${
                        isActive ? "text-white/95" : "text-[#7ea0bd]"
                      }`}
                    >
                      {item}
                    </p>
