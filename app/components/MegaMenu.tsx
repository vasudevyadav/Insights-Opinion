...
export default function MegaMenu({ open, services }: MegaMenuProps) {
    const [activeTab, setActiveTab] = useState<string | null>(services[0]?.id ?? null);
    const activeService =
    ...
    return (
        <div
            className={`absolute left-48 top-[12px] z-50 mt-4 w-[1100px] -translate-x-1/2 transform transition-all duration-300 ease-out ${open
